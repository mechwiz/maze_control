...
class sphero_finder:
    ...
    def imagecb(self,data):
        try:
            ...
            cv2.createTrackbar('Lower Hue','Converted Image',self.lower_red[0],180,nothing)
            cv2.createTrackbar('Lower Sat','Converted Image',self.lower_red[1],255,nothing)
            cv2.createTrackbar('Lower Value','Converted Image',self.lower_red[2],255,nothing)
            cv2.createTrackbar('Upper Hue','Converted Image',self.upper_red[0],180,nothing)
            cv2.createTrackbar('Upper Sat','Converted Image',self.upper_red[1],255,nothing)
            cv2.createTrackbar('Upper Value','Converted Image',self.upper_red[2],255,nothing)
            switch = '0 : OFF \n1 : ON'
