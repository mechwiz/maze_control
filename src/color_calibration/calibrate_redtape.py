...
class image_overlay:
    ...
    def imagecb(self,data):
        try:
            ...
            cv2.createTrackbar('Lower Hue','Converted Image',self.lower_redtape[0],180,nothing)
            cv2.createTrackbar('Lower Sat','Converted Image',self.lower_redtape[1],255,nothing)
            cv2.createTrackbar('Lower Value','Converted Image',self.lower_redtape[2],255,nothing)
            cv2.createTrackbar('Upper Hue','Converted Image',self.upper_redtape[0],180,nothing)
            cv2.createTrackbar('Upper Sat','Converted Image',self.upper_redtape[1],255,nothing)
            cv2.createTrackbar('Upper Value','Converted Image',self.upper_redtape[2],255,nothing)
            ...
            lower_redtape = np.array([lowh,lows,lowv])
            upper_redtape = np.array([upph,upps,uppv])
            ...
            maskdots = cv2.inRange(hsv,lower_redtape, upper_redtape)
